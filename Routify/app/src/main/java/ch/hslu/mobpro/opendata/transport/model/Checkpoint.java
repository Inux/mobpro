...
package ch.hslu.mobpro.opendata.transport.model;
...
public class Checkpoint {
    ...
    @Expose
    private ch.hslu.mobpro.opendata.transport.model.Prognosis prognosis;
    @SerializedName("station")
    @Expose
    private ch.hslu.mobpro.opendata.transport.model.Station station;
